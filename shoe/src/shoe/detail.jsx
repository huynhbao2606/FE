...
import { setCart} from "../store/shoppingShoeReducer.js";

export default function Detail() {
    const dispatch = useDispatch();
    const detailShoe = useSelector(
        (state) => state.shoppingShoeReducer.detailShoe
    )
    ...
    return (
        <div
            ...
            tabIndex={-1}
            aria-hidden="true"
            className="hidden fixed inset-0 z-[100] items-center justify-center p-4"
            role="dialog"
        >
            <div
            ...
            <div className="relative z-10 w-full max-w-4xl rounded-2xl bg-white dark:bg-gray-900 shadow-2xl border border-gray-200 dark:border-gray-700">
                ...
                <div className="flex items-center justify-end gap-3 border-t border-gray-200 dark:border-gray-700 p-4">
                    ...
                    <button
                        ...
                        type="button"
                        onClick={() => dispatch(setCart(detailShoe))}
                    >
                        Thêm vào giỏ
                    </button>
                </div>
