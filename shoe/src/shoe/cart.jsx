...
import {setRemoveCart, setUpdateQuanTity, setPayment} from "../store/shoppingShoeReducer";

const Cart = () => {
    const dispatch = useDispatch();
    const listCart = useSelector((state) => state.shoppingShoeReducer.listCart);
        ...
        return listCart.map((item, idx) => (
            ...
            >
                ...
                <td className="px-6 py-4 text-center">
                    <div className="max-w-xs mx-auto">
                        <div className="relative flex items-center max-w-[8rem]">
                            <button type="button" id="decrement-button" onClick={() => dispatch(setUpdateQuanTity({id: item.id, isPlus: false}))}
                            ...
                            <button type="button" id="increment-button" onClick={() => dispatch(setUpdateQuanTity({id: item.id, isPlus: true}))}
                ...
                <td className="px-6 py-4 text-right w-20">
                    <button
                        type="button"
                        onClick={() => dispatch(setRemoveCart(item.id))}
